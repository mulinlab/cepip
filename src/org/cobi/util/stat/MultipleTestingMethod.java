...
public class MultipleTestingMethod {
    ...
    //, which is called a 鈥渟tep-down method,鈥�   
...
//The Benjamini-Hochberg method aims to control the FDR, or 鈥淔alse Discovery Rate,鈥�rather than the FWE or 鈥淔amilyWise Error rate.鈥�//FDR is defined as
//FDR = E{ (false rejections)/(total rejections) }.   
// Benjamini-Hochberg method is a 鈥渟tep-up鈥�metho
...
//two side test
            ...
            //Critical Values of 卤W for Small Samples
